...
public interface Iterable<T> {
     ...
     * @return an Iterator.
     */
    Iterator<T> iterator();  //借助外部迭代器实现遍历
     ...
     * @since 1.8
     */
    default void forEach(Consumer<? super T> action) {  //流式遍历。遍历每个元素，并对其执行相应的择取操作
     ...
     * @since 1.8
     */
    default Spliterator<T> spliterator() {  //将普通迭代器转换为可分割迭代器，用于流式操作
