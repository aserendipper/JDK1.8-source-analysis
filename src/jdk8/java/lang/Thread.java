...
class Thread implements Runnable {
    ...
    */
     ...
     * 此字段指向的是ThreadLocal类中的内部类ThreadLocalMap
     * ThreadLocal能进行存储的原理
    */
   ...
   /**
    ...
    public synchronized void start() {
         ...
         * 通知线程组此线程准备运行，当前线程即将启动，线程组当前启动线程数+1，未启动线程数-1
         * */
        group.add(this);
        //启动标识
